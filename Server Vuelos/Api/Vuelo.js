...
route.post("/postVuelo", async(req, res) => {
    let { origen, destino, precio, hora, fecha, disponible, stock } = req.body;
    let vuelo = {};
    vuelo.origen = origen;
...
route.put("/modificaVuelo/:Id/:origen/:destino/:precio/:hora/:fecha/:disponible/:stock", async(req, res) => {
